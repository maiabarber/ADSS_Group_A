...
public class CreateDeliveryDTO {
    ...
    public CreateDeliveryDTO(int deliveryId, String deliveryDate, int sourceSiteId, String departureTime, double finalMeasuredWeight, String truckLicenseNumber, String driverEmployeeId, String zoneCode, String status) {
    ...
    public double getFinalMeasuredWeight() { return finalMeasuredWeight; }
    public String getTruckLicenseNumber() { return truckLicenseNumber; }
    public String getDriverEmployeeId() { return driverEmployeeId; }
